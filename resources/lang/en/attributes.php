...
return [
    ...
    'plan_outgrown_renewal' => 'Your stores use more than :plan allows, so it cannot renew. Change to a plan that fits to keep your stores online.',
    'plan_outgrown_change' => 'Outgrown: change plan to renew',
    'plan_change_from' => 'switches on :date',
    'plan_includes' => 'Includes: :items',
    'plan_includes_stores' => '{1} :count store|[2,*] up to :count stores',
    'plan_limit_value' => ':limit: :value',
    'plan_limit_unlimited' => ':limit: unlimited',
